...
#include <selene/DEPRECATED_img_io/JPEGWrite.hpp>
...
TEST_CASE("JPEG image reading and writing, no conversion", "[DEPRECATED_img]")
{
...
TEST_CASE("JPEG image reading and writing, conversion to grayscale", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading, reusing decompression object", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image writing, reusing compression object", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading and writing, partial image reading", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading and writing, reading/writing from/to memory", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading, through JPEGReader interface", "[DEPRECATED_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
