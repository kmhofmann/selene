...
constexpr auto w = 3_px;
constexpr auto h = 4_px;
...
{
  sln::Image_8u1 img_r(w, h);
  sln::Image_8u1 img_g(w, h);
  sln::Image_8u1 img_b(w, h);
  img_r.fill(val_r);
  img_g.fill(val_g);
  img_b.fill(val_b);
