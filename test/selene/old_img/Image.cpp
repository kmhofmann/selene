...
#include <test/selene/old_img/_TestImages.hpp>
...
TEST_CASE("Image construction", "[old_img]")
{
...
TEST_CASE("Image iteration", "[old_img]")
{
...
TEST_CASE("Image comparison", "[old_img]")
{
...
TEST_CASE("Image view creation", "[old_img]")
{
