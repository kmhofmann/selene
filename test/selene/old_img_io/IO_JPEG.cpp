...
TEST_CASE("JPEG image reading and writing, no conversion", "[old_img]")
{
...
TEST_CASE("JPEG image reading and writing, conversion to grayscale", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading, reusing decompression object", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image writing, reusing compression object", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading and writing, partial image reading", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading and writing, reading/writing from/to memory", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
...
TEST_CASE("JPEG image reading, through JPEGReader interface", "[old_img]")
{
  const auto tmp_path = sln_test::get_tmp_path();
