...
struct ImageBorderAccessor<BorderAccessMode::Unchecked>
{
  ...
  static decltype(auto) access(const ImageBase<DerivedSrc>& img, PixelIndex x, PixelIndex y) noexcept;
...
{
  template <typename DerivedSrc>
  static auto access(const ImageBase<DerivedSrc>& img, PixelIndex x, PixelIndex y) noexcept;
...
ImageBorderAccessor<BorderAccessMode::Unchecked>::access(const ImageBase<DerivedSrc>& img,
                                                         PixelIndex x,
...
template <typename DerivedSrc>
inline auto
ImageBorderAccessor<BorderAccessMode::ZeroPadding>::access(const ImageBase<DerivedSrc>& img,
                                                           PixelIndex x,
                                                           PixelIndex y) noexcept
{
...
template <typename DerivedSrc>
inline decltype(auto)
ImageBorderAccessor<BorderAccessMode::Replicated>::access(const ImageBase<DerivedSrc>& img,
                                                          PixelIndex x,
                                                          PixelIndex y) noexcept
{
  if (x < 0)
